      ...
      <div class="container">
        <div class="row align-items-center g-lg-5 py-5">
          <div class="col-lg-7 text-center text-lg-start">
            <h1 class="display-4 fw-bold lh-1 text-body-emphasis mb-3">Bienvenu sur <span class="display-2 fw-bold lh-1 mb-3 e">E</span><span class="display-4 fw-bold lh-1 mb-3 mifi">MIFI</span><i class="fas fa-headphones-alt display-2" style="margin-left:10px"> </i></h1>
